...
for (i in seatLayout){
    console.log(seatLayout[i])
}
console.log(seatLayout.length)
...
for (i in carNumbers){
    if (usageMinutes[i] >= 30) {
        totalFee = 1000
        for (j=30; j< parseInt(usageMinutes[i]/10)*10; j+=10){
            if (totalFee >= 20000) { break }
            totalFee +=500
        }
